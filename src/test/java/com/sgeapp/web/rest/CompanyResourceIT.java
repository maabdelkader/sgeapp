...
import com.sgeapp.service.mapper.CompanyMapper;
...
class CompanyResourceIT {
    ...
    private static final CompanyType DEFAULT_COMPANY_TYPE = CompanyType.SGE;
    private static final CompanyType UPDATED_COMPANY_TYPE = CompanyType.CMCAS;
    ...
    public static Company createEntity(EntityManager em) {
        Company company = new Company().name(DEFAULT_NAME).raisonSocial(DEFAULT_RAISON_SOCIAL).companyType(DEFAULT_COMPANY_TYPE);
        return company;
    }
    ...
    public static Company createUpdatedEntity(EntityManager em) {
        Company company = new Company().name(UPDATED_NAME).raisonSocial(UPDATED_RAISON_SOCIAL).companyType(UPDATED_COMPANY_TYPE);
        return company;
    }
    ...
    void createCompany() throws Exception {
        ...
        assertThat(testCompany.getRaisonSocial()).isEqualTo(DEFAULT_RAISON_SOCIAL);
    ...
    void putNewCompany() throws Exception {
        ...
        updatedCompany.name(UPDATED_NAME).raisonSocial(UPDATED_RAISON_SOCIAL).companyType(UPDATED_COMPANY_TYPE);
        ...
        assertThat(testCompany.getRaisonSocial()).isEqualTo(UPDATED_RAISON_SOCIAL);
    ...
    void partialUpdateCompanyWithPatch() throws Exception {
        ...
        partialUpdatedCompany.raisonSocial(UPDATED_RAISON_SOCIAL).companyType(UPDATED_COMPANY_TYPE);
    ...
    void fullUpdateCompanyWithPatch() throws Exception {
        ...
        partialUpdatedCompany.name(UPDATED_NAME).raisonSocial(UPDATED_RAISON_SOCIAL).companyType(UPDATED_COMPANY_TYPE);
